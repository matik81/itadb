...
def assign_citizenship(
    ...
    """Assign from base_persons into assigned; no household attributes are consulted."""
    cells = scratch / "cells.csv"
    ...
    cells.unlink()
    countries = scratch / "countries.csv"
...
def enrich_batch(
    ...
    with duckdb.connect() as con:
        ...
        assign_citizenship(con, municipalities, year, output, progress)
