...
| Componente demografica | [national-reference-v1.json](national-reference-v1.json) |
| Componente cittadinanza | [citizenship-reference-v1.json](citizenship-reference-v1.json) |
